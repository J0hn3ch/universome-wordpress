...
function uvm_registration_form_activate() {
    ...
    /* ### Style registration ### */
    // Fonte: https://webdesign.tutsplus.com/it/tutorials/loading-css-into-wordpress-the-right-way--cms-20402
    wp_register_style(
        'uvm-registration-style',
...
function uvm_registration_load(){
    ...
    if ( get_option( 'Activated_Plugin' ) == 'UVM-Registration-Form' ) {
